...
import type { FinanceInvoiceTimelineEvent, FinanceInvoiceTimelineTone } from "../financeInvoiceDetail";

const dotClasses: Record<FinanceInvoiceTimelineTone, string> = {
  success: "bg-success",
  warning: "bg-warning",
  danger: "bg-danger",
  muted: "bg-text-muted",
...
export function FinanceInvoiceTimelineCard({ events }: { events: FinanceInvoiceTimelineEvent[] }) {
  return (
